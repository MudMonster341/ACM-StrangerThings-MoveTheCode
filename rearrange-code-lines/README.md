# Rearraning Code Lines
Flask server for the Rearranging Code Lines game
...
```bash
git clone https://github.com/Sanvit-Katrekar/rearrange-code-lines
cd rearrange-code-lines
```
